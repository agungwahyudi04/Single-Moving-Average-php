...
if (isset($_POST['ubah']))
{
  $connect->query("UPDATE admin SET nama_admin='$_POST[nama]', username='$_POST[username]', password='$_POST[password]' WHERE id_admin='$_GET[id]'");
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li><a class="active-menu" href="admin.php"><i class="fa fa-desktop "></i>Admin</a></li>
